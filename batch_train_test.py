...
def get_label_file_name(folder_name, suffix=""):
	if "valAds" in folder_name:
		labelName = "labelsAds_val"
	elif "valA" in folder_name:
	...
	elif "valHs" in folder_name:
		labelName = "labelsHs_val"
	elif "valHm" in folder_name:
		labelName = "labelsHm_val"
	elif "valH" in folder_name:
		labelName = "labelsH_val"
	elif "trainAds" in folder_name:
		labelName = "labelsAds_train"
	elif "trainA" in folder_name:
		labelName = "labelsA_train"
	elif "trainB0.1" in folder_name:
		labelName = "labelsB0.1_train"
	...
	elif "trainHs" in folder_name:
		labelName = "labelsHs_train"
	elif "trainHm" in folder_name:
		labelName = "labelsHm_train"
	elif "trainH" in folder_name:
		labelName = "labelsH_train"
...
def single_test():
	...
	outputPath = TEST_OUTPUT_ROOT + "(" + train_folder + ")_(" + val_folder + ")_test/test_result.txt"
	modelPath = ""
