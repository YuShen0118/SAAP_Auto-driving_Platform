...
from library.inception import InceptionV3
...
def calculate_fid_given_list_files_csv(list_files_pair, data_folders_pair, batch_size, cuda, dims):
...
def calculate_fid_given_multi_list_files(list_files, batch_size, cuda, dims):
    ...
    for i in range(len(list_files)):
        ...
        m, s = calculate_activation_statistics(one_list, model, batch_size, dims, cuda)
