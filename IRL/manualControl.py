...
def play(use_expert = False):
    ...
    #game_state = carmunk.GameState(scene_file_name = 'scenes/scene-ground-car.txt', use_expert=use_expert)   # set up the simulation environment
    #game_state = carmunk.GameState(scene_file_name = 'scenes/scene-city-car.txt', use_expert=use_expert)   # set up the simulation environment
    game_state = carmunk.GameState(scene_file_name = 'scenes/scene-city.txt', use_expert=use_expert)   # set up the simulation environment
    ...
    while True:
        ...
        _, _, readings, _, _ = game_state.frame_step(action)
